...
func (in *MetricTarget) DeepCopyInto(out *MetricTarget) {
	*out = *in
	...
	if in.AverageRange != nil {
		in, out := &in.AverageRange, &out.AverageRange
		*out = new(MetricTargetRange)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricTargetRange) DeepCopyInto(out *MetricTargetRange) {
	*out = *in
	out.Upper = in.Upper.DeepCopy()
	out.Lower = in.Lower.DeepCopy()
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricTargetRange.
func (in *MetricTargetRange) DeepCopy() *MetricTargetRange {
	if in == nil {
		return nil
	}
	out := new(MetricTargetRange)
